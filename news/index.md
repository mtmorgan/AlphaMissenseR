...
## AlphaMissenseR 1.6.0

- (v. 1.5.4) Avoid gghalves in ‘benchmarking’ vignette for compatilibity
...
- (v. 1.1.7) Add ‘Benchmarking with ProteinGym’ vignette to benchmark
  ...
  [@tram-nguyen-n](https://github.com/tram-nguyen-n)
- (v. 1.1.6) Add
  [`gosling_plot()`](https://mtmorgan.github.io/AlphaMissenseR/reference/Gosling.md)
  for visualizing variants as bar or lollipop plots. Merges
  <https://github.com/mtmorgan/AlphaMissenseR/pull/6> Thanks
  [@lee-t](https://github.com/lee-t).
- (v. 1.1.4) Add
  ...
  for visualizing ClinVar data. Merges
...
- (v. 1.1.2)
  ...
  returns a tibble with 21 columns, instead of 20. Merges
...
- (v. 0.99.16) Housekeeping
  ...
  - Use rjsoncons (\>= 1.0.1), so that jsonlite is not a hard
    dependency.
  - Acknowledge additional funding sources; add ImmunoOncology biocViews
    term.
- (v. 0.99.15) Respond to Bioconductor reviewer comments
  ...
  - See GitHub [issue
    comment](https://github.com/Bioconductor/Contributions/issues/3221#issuecomment-1804040387);
    thanks [@LiNk-NY](https://github.com/LiNk-NY)
- (v. 0.99.11) Use an S4 class for `alphamissense_connection`, extending
  `duckdb_connection`.
